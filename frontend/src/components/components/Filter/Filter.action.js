...
export const setQueryTagInFilter = createAction(SET_QUERY_TAG_IN_FILTER, queryTag => ({ queryTag }))
...
export const fetchTagsInFilter = createAction(FETCH_TAGS_IN_FILTER, tags => ({ tags }))
...
export const changeSelectedTagsInFilter = createAction(
  CHANGE_SELECTED_TAGS_IN_FILTER, tag => ({ tag }))
