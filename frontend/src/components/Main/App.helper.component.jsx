...
export const LoadMore = ({ totalNumberOfTasks, numbers, tabIndex, onLoadMore }) => (
  <div className={scssClasses.button}>
    {
      totalNumberOfTasks[tabIndex] > numbers[tabIndex] ? (
        <CustomizedButton
          label="Load More"
...
LoadMore.propTypes = {
  totalNumberOfTasks: PropTypes.shape({}).isRequired,
