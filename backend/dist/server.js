...
"use strict";
eval("/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mongoose__ = __webpack_require__(/*! mongoose */ \"mongoose\");\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mongoose___default = __webpack_require__.n(__WEBPACK_IMPORTED_MODULE_0_mongoose__);\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__setup_server__ = __webpack_require__(/*! ../../../setup/server */ \"./setup/server.js\");\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__db__ = __webpack_require__(/*! ./db */ \"./logic/components/task/db.js\");\n/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__helper__ = __webpack_require__(/*! ./helper */ \"./logic/components/task/helper.js\");\n// modules\n\n// components\n\n// db helpers\n\n// helpers\n\n// const\nconst logger = console.log;\n\n__WEBPACK_IMPORTED_MODULE_1__setup_server__[\"a\" /* default */].post('/saveTask', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_2__db__[\"c\" /* saveTask */])(req.body).then(task => res.send(task)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_1__setup_server__[\"a\" /* default */].post('/deleteTask', (req, res) => Object(__WEBPACK_IMPORTED_MODULE_2__db__[\"a\" /* deleteTask */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(req.query._id) }).then(() => res.send('deleted successfully!')).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_1__setup_server__[\"a\" /* default */].post('/changeLevel', ({ body }, res) => Object(__WEBPACK_IMPORTED_MODULE_2__db__[\"d\" /* updateTask */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(body._id) }, { $set: { level: body.nextLevel } }).then(() => res.send(body)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_1__setup_server__[\"a\" /* default */].post('/setSentTime', ({ body: { _id, sentTime } }, res) => Object(__WEBPACK_IMPORTED_MODULE_2__db__[\"d\" /* updateTask */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(_id) }, { $set: { sentTime } }).then(() => res.send('sent time set!')).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_1__setup_server__[\"a\" /* default */].post('/toggleTodo', ({ body: { _id, todoId, task } }, res) => Object(__WEBPACK_IMPORTED_MODULE_2__db__[\"d\" /* updateTask */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(_id), 'todos._id': todoId }, { $set: { 'todos.$.completed': Object(__WEBPACK_IMPORTED_MODULE_3__helper__[\"a\" /* getToggledValue */])(task, todoId) } }).then(() => res.send('toggled successfully!')).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_1__setup_server__[\"a\" /* default */].post('/addTodo', ({ body }, res) => Object(__WEBPACK_IMPORTED_MODULE_2__db__[\"d\" /* updateTask */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(body._id) }, { $push: { todos: { $each: [{ title: body.value, completed: false }], $position: 0 } } }).then(() => Object(__WEBPACK_IMPORTED_MODULE_2__db__[\"b\" /* fetchTasks */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(body._id) })).then(task => res.send(task)).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_1__setup_server__[\"a\" /* default */].post('/deleteTodo', ({ body: { _id, todoId } }, res) => Object(__WEBPACK_IMPORTED_MODULE_2__db__[\"d\" /* updateTask */])({ _id: __WEBPACK_IMPORTED_MODULE_0_mongoose___default.a.Types.ObjectId(_id) }, { $pull: { todos: { _id: todoId } } }).then(() => res.send('deleted successfully!')).catch(logger));\n\n__WEBPACK_IMPORTED_MODULE_1__setup_server__[\"a\" /* default */].get('/loadMore', ({ query }, res) => Object(__WEBPACK_IMPORTED_MODULE_2__db__[\"b\" /* fetchTasks */])(query).then(tasks => res.json(tasks)).catch(logger));\n\n//////////////////\n// WEBPACK FOOTER\n// ./logic/components/task/route.js\n// module id = ./logic/components/task/route.js\n// module chunks = 0\n\n//# sourceURL=webpack:///./logic/components/task/route.js?");
